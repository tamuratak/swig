...
%define %swig_unordered_set_methods(set...)
...
// Redefine std::unordered_set iterator/reverse_iterator typemap
...
// Redefine std::unordered_set std::pair<iterator, bool> typemap
